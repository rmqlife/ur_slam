...
class GameUI:
    ...
    def start_game(self):
        ...
        self.robot_entry.insert(0, "robot1")  # Set default value
    ...
    def monitor_signals(self):
        ...
        while self.is_monitoring:
            ...
            if self.controller.inputs:
                ...
                if self.last_signal_time > 0 and current_time - self.last_signal_time > 5:
    ...
    def stop_recording(self):
        ...
        self.is_recording = False
        file_path = f'data/{self.time_str}/action_{self.action_num}'
        self.info_saver.save_robot_state(file_path)
        self.info_saver.save_image_buffer(file_path)
        print(f"Stopped recording and saved data for action {self.action_num}")
        self.action_num += 1
