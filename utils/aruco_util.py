...
def estimate_markers_poses(corners, marker_size, mtx, distortion):
    '''
...
def main_detect_video():
    ...
    cap = cv2.VideoCapture(0)  # Change to your camera index or video file path
    ...
    while cap.isOpened():
        ...
        frame = estimate_markers_poses(frame, marker_size=0.1, intrinsics=intrinsics)  # Marker size in meters
